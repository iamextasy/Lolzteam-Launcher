    ...
    <>
      <div className={s.settingsContainer}>
        ...
        <div className={s.settingsItem}>
          ...
          <button type="button" className={s.settingsMenu} onClick={() => setLangOpen(true)}>
            <div className={s.text}>
          ...
          <button type="button" className={s.settingsMenu} onClick={() => setShowProxy(true)}>
            <div className={s.text}>
      ...
      {langOpen && (
        ...
        >
          <div
            ...
            role="radiogroup"
            aria-label={t('settings.language.modalTitle')}
          >
            {LOCALE_OPTIONS.map((opt) => {
              const active = currentLocale === opt;
              return (
                <label key={opt} className={`${s.langOption} ${active ? s.langOptionActive : ''}`}>
                  <input
                    type="radio"
                    name="locale"
                    value={opt}
